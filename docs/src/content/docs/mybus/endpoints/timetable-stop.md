...
```
${BASE}/GetTimeTableReal
```

## Logic

This API call is mainly used for the purposes of displaying departures. Example of it being a Information display board like [this](http://www.rg.com.pl/oferta/urzadzenia/tablice-informacyjne/dworcowe-przystankowe-peronowe,150.html) or in a [web form](https://sip.ztm.lublin.eu/RTT.aspx?id=1002) and in this view.

![Timetable for stop](../../../../assets/screenshots/timetable-stop.PNG)

When app is in online mode this view's table is generated from API data.

## Params

-   `nBusStopId` - Stop SIP id
